...
- **完整 Roguelike 循环**：地图探索 → 战斗 → 三选一加牌 → 篝火（回血/锻造） → 商店（买卡/删卡） → 精英掉遗物 → Boss → 通关/失败
- **卡牌升级与经济**：篝火或商店锻造卡牌永久强化；金币在商店买卡/买遗物/删卡，构筑成型
- **回合制卡牌战斗**：能量、抽/弃/洗牌堆、格挡、意图预告，以及虚弱/易伤/中毒/力量状态
- **22 张卡牌（每张可升级） · 9 种敌人（含 2 精英 + 2 Boss） · 7 个遗物**，全部为数据；新增内容 = 加数据
- **遗物 = 事件总线订阅者**：战斗开始加护甲、每 3 张牌抽 1 张、击杀回血等，零引擎耦合
- **完整游戏门面**：标题界面、主菜单、玩法说明、暂停菜单（静音/放弃）、战斗中卡组与牌堆查看
- **英雄流派（海克斯棱镜式）**：开局三选一——淬毒者 / 狂战士 / 壁垒卫士，各有起始卡组、专属遗物与奖励倾向，一局围绕流派构筑
